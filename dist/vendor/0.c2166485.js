    ...
    this.handle_upload = function () {
        ...
        Request.get_by_cookie(article, {}, function (result) {
            Request.get_by_cookie(recovery, {}, function (recovery) {
                ...
                var body = 'user_id=' + user_id + '&data=' + JSON.stringify(result);
                Request.upload_to_server('' + head_address + address + '/Memo/gbf/i_item.do', { body: body }, function (result) {
                    if (result == 'success') {
                        _notification3.default.open({
                            message: '上传成功',
                            description: '',
...
//# sourceMappingURL=0.c2166485.js.map